    ...
    <body>
        ...
        <div class="page-wrap">
            ...
            <%
                ...
                if ("event_not_found".equals(error)) { out.println("<div class=\"alert alert-error\"><strong>&#10007; Event Not Found!</strong></div>"); }
                else if ("registered".equals(status)) { out.println("<div class=\"alert alert-success\"><strong>&#10003; Successfully registered for the event!</strong></div>"); }
                else if ("registration_failed_or_already_registered".equals(status)) { out.println("<div class=\"alert alert-error\"><strong>&#10007; Already registered or registration failed.</strong></div>"); }
                else if ("event_full".equals(error)) { out.println("<div class=\"alert alert-error\"><strong>&#10007; Sorry, this event is already full!</strong></div>"); }
            %>
            ...
            <div class="card">
                ...
                <div class="table-wrap">
                    ...
                    <tbody>
                        ...
                        <% } else { for (event ev : activeEvents) { %>
                        <tr>
