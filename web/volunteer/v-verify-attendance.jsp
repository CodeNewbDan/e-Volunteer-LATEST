...
<%
    ...
    if (currentVolunteer == null) { response.sendRedirect(request.getContextPath() + "/public/v-login.html"); return; }
%>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        ...
        <div class="page-wrap">
            ...
            <%
                ...
                if ("1".equals(error)) { out.println("<div class=\"alert alert-error\"><strong>&#10007; Incorrect verification code. Please try again!</strong></div>"); }
                else if ("missing_fields".equals(error)) { out.println("<div class=\"alert alert-error\"><strong>&#10007; Please select an event and fill in the code.</strong></div>"); }
                else if ("database_error".equals(error)) { out.println("<div class=\"alert alert-error\"><strong>&#10007; System error during database transaction.</strong></div>"); }
            %>
