    ...
    <body>
        ...
        <div class="page-wrap" style="max-width:700px;">
            ...
            <%
                ...
                if ("success".equals(status)) { out.println("<div class=\"alert alert-success\"><strong>&#10003; Profile updated!</strong></div>"); }
                else if ("wrong_password".equals(status)) { out.println("<div class=\"alert alert-error\"><strong>&#10007; Current Password incorrect.</strong></div>"); }
                else if ("password_mismatch".equals(status)) { out.println("<div class=\"alert alert-error\"><strong>&#10007; New passwords do not match!</strong></div>"); }
                else if ("missing_fields".equals(status)) { out.println("<div class=\"alert alert-error\"><strong>&#10007; Please fill in all required fields.</strong></div>"); }
                else if ("error".equals(status)) { out.println("<div class=\"alert alert-error\"><strong>&#10007; System error updating profile.</strong></div>"); }
            %>
