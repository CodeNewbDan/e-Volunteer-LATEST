    ...
    <body>
        ...
        <div class="page-wrap">
            ...
            <%
                ...
                if ("created".equals(status)) { out.println("<div class=\"alert alert-success\"><strong>&#10003; New campaign added!</strong></div>"); }
                else if ("updated".equals(status)) { out.println("<div class=\"alert alert-success\"><strong>&#10003; Campaign updated.</strong></div>"); }
                else if ("deleted".equals(status)) { out.println("<div class=\"alert alert-info\"><strong>&#8505; Campaign removed from registry.</strong></div>"); }
                else if ("error".equals(status)) { out.println("<div class=\"alert alert-error\"><strong>&#10007; Database error occurred.</strong></div>"); }
            %>
