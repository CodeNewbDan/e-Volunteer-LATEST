...
// 2. Extract selected Status Filter (defaults to 'Active')
    String viewStatus = request.getParameter("viewStatus");
    if (viewStatus == null || viewStatus.trim().isEmpty()) {
        viewStatus = "Active";
    }
%>
<!DOCTYPE html>
        ...
        <div class="page-wrap">
            ...
            <%
                ...
                try {
                    ...
                    out.println("<div class=\"alert alert-error\">Metric error: " + ex.getMessage() + "</div>");
                }
            %>
